...
def main():
    parser = argparse.ArgumentParser(
        description="Train the final integrated image-restoration model."
    )

    parser.add_argument("--lr-dir", required=True,
                        help="Directory containing degraded/low-resolution .npy images.")
    parser.add_argument("--gt-dir", required=True,
                        help="Directory containing matching ground-truth .npy images.")
    parser.add_argument(
        "--output",
    ...
    # --------------------------------------------------------
    # 4–6. TRAIN → VALIDATE → SELECT BEST
    # --------------------------------------------------------
